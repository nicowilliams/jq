...
OP(CALL_JQ_VARARG, UVFUNC, 2, 1)
OP(TAIL_CALL_JQ_VARARG, UVFUNC, 2, 1)
OP(LOAD_VARARG_COUNT, NONE, 1, 1)
...
OP(CLOSURE_PARAM_VARARG_ARRAY, DEFINITION, 0, 0)
OP(CLOSURE_PARAM_VARARG_ARRAY_LENGTH, DEFINITION, 0, 0)
