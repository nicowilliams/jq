...
typedef int (*jv_object_contains_f)(jv,jv);
...
typedef int (*jv_array_contains_f)(jv,jv);
...
struct jq_plugin_vtable {
  ...
  jv_object_contains_f jv_object_contains;
  ...
  jv_array_contains_f jv_array_contains;
...
#define jv_array_contains ((*(struct jq_plugin_vtable **)jq)->jv_array_contains)
...
#define jv_object_contains ((*(struct jq_plugin_vtable **)jq)->jv_object_contains)
