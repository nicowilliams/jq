...
jq_util_input_state jq_util_input_state_init(jq_err_cb, void *);
void jq_util_input_state_set_parser(jq_util_input_state, jv_parser *, int);
void jq_util_input_state_free(jq_util_input_state *);
void jq_util_input_state_add_input(jq_util_input_state, jv);
int jq_util_input_state_open_errors(jq_util_input_state);
int jq_util_input_state_read_more(jq_util_input_state);
jv jq_util_input_state_next_input(jq_util_input_state);
jv jq_util_input_state_next_input_cb(jq_state *, void *);
